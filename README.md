...
Все выражения сохраняются в базе данных SQLlite, доступ к ним доступен после перезагрузки калькулятора.
...
<img src="readme_assets/Scheme.png">
...
Присутствуют тесты (в основном модульные, но и интеграционные также есть)
...
Если хочется что-нибудь спросить или чему-нибудь меня научить (я буду этому очень рад), оставляйте ишью, либо: ArtemiyKrd@yandex.ru  :)

**Спасибо большое всем создателям курса, ребятам-сокурсникам за помощь и просто хорошее настроение. Пусть все станут теми, кем мечтают**